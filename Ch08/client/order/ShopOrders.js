...
// Pg 386, List orders
  ...
  // Pg 387, method is passed as a prop to the ProductOrderEdit component so that the status can be updated when a product status is changed
  ...
  // Pg 386, iterate through the list of orders and render each order in a collapsbile list from Material-UI
    return (
    <div>
