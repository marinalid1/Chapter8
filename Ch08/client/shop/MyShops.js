...
export default function MyShops(){
  ...
  // Pg 308, alllows us to update the state with the modified list of shops for the current user and is defined in the MyShops component
  ...
  // Pg 307, the MyShops component
  // Pg 317, the DeleteShop component
    if (redirectToSignin) {
