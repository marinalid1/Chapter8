...
export default function Shops(){
  ...
  // Pg 304, retrieved shops array is iterated over using map, with each shop's data rendered in the view in a Material-UI ListItem
    return (
    <div>
