...
// Pg 328, the relevant products are first loaded in a state with an useEffect hook using the listBySHop fetch method
export default function MyProducts (props){
  ...
  // Pg 329, onRemove prop to the DeleteProduct component
    return (
