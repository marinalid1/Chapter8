...
// Pg 335, product details and the related product list data will be fetched by calling the relevant APIs with the useEffect hooks using the productId specified in the route param
export default function Product ({match}) {
  ...
  return function cleanup(){
    ...
    // Pg 336, the product details part of the component displays relevant information about the product and an AddToCart component in a Material-UI card component
    // Pg 337, the suggestions component is added in the Product view with the related list data passed as a prop
    return (
