...
// Pg 376, clicking on the PlaceOrder button will call the placeOrder
const PlaceOrder = (props) => {
  ...
  // Pg 375, Using stripe card elements
  const placeOrder = ()=>{
...
// Pg 375, The CardElements component
// Pg 376, Adding a button to place an order
// Pg 377, Redirecting to the order view
    if (values.redirect) {
