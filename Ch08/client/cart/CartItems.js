...
//Pg 355, retrieve the cart items using the getCart helper method and set it to the state of the intial value of cartItems
export default function CartItems (props) {
  const classes = useStyles()
  const [cartItems, setCartItems] = useState(cart.getCart())

  // Pg 356, called to enforce the minimum value validation
  ...
  // Pg 358, calculate the total price of the items in the cart
  const getTotal = () => {
  ...
  // Pg 357, removeItem removes items from the cart in local storage
  ...
  // Pg 359, will use the setCheckout method passed as a prop to set the checkout value to true in the cart component
  const openCheckout = () => {
    props.setCheckout(true)
  }

  // Pg 354, the CartItems component
  // Pg 355, cartItems array that was retrieved from localStorage is iterated over using the map function to render the details of each item
  // Pg 356, Modifying quantity
  // Pg 357, Removing items
  // Pg 358, showing the total price
  // Pg 359, option to check out
